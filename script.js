...
(function initMemeGenerator() {
  ...
  const TEMPLATES = [
    ...
    { label: 'Gru\'s Plan',        url: 'https://i.imgflip.com/26jxvz.jpg'  },
    { label: 'Evil Kermit',        url: 'https://i.imgflip.com/1e7ql7.jpg'  },
    { label: 'Always Has Been',    url: 'https://i.imgflip.com/46e43q.png'  },
    ...
    { label: 'Is This a Pigeon',   url: 'https://i.imgflip.com/1o00in.jpg'  },
    { label: 'Batman Slapping',    url: 'https://i.imgflip.com/9ehk.jpg'    },
    { label: 'Oprah You Get',      url: 'https://i.imgflip.com/gtj5t.jpg'   },
    { label: 'Sad Pablo Escobar',  url: 'https://i.imgflip.com/1c1uej.jpg'  },
    ...
    { label: 'Ancient Aliens',     url: 'https://i.imgflip.com/26am.jpg'    },
    { label: 'UNO Draw 25',        url: 'https://i.imgflip.com/3lmzyx.jpg'  },
    { label: 'Monkey Puppet',      url: 'https://i.imgflip.com/2gnnjh.jpg'  },
    { label: 'Grandma & Internet', url: 'https://i.imgflip.com/1bhw.jpg'    },
    { label: 'Bike Fall',          url: 'https://i.imgflip.com/1b42wl.jpg'  },
    { label: 'Mocking Spongebob',  url: 'https://i.imgflip.com/1otk96.jpg'  },
    { label: 'Running Away',       url: 'https://i.imgflip.com/261o3j.jpg'  },
    { label: 'Panik Kalm',         url: 'https://i.imgflip.com/3qqcim.png'  },
    { label: 'They\'re the Same',  url: 'https://i.imgflip.com/2za3u1.jpg'  },
  ];
